...
public class StrList {
    public static void main(String[] args) {
        ...
        // 배열에 element를 넣는 방법
        strArray1[0] = "김영";
        // List에 element를 넣는 방법  -> 배열과 달리 method를 통해서 elemnet를 넣어야 함.
        strList1.add("java");
        strList1.add("python");
        strList1.add("C#");
        ...
        // 특정 element의 포함 여부 -> contain() 메서드를 사용 -> return boolean
        String searchElem1 = "python";      // 하드 코딩을 피하기 위해 변수 대입
        boolean contains1 = strList1.contains(searchElem1);     // elem이란 표현은 element의 축약어로 쓰임
        System.out.println(searchElem1 + "의 포함 여부" + contains1);

        String searchElem2 = "py";      // 하드 코딩을 피하기 위해 변수 대입
        boolean contains2 = strList1.contains(searchElem2);     // elem이란 표현은 element의 축약어로 쓰임
        ...
        // element의 일부만 가지고 삭제하는것이 불가능(일부로 element 전체 삭제 불가능,
        // 또한 removeElem2 = "py"로 했을 때
        // sout(strList1)의 결과값 중 element로 "py"만 사젝하고 thon만 남는 것이 불가능
        ...
        // List의 정렬 -> 배열과 동일
        Collections.sort(strList1);     // 마찬가지로 배열 원본 바꿈
        ...
        // 참고 : strList1.length는 안먹습니다. -> List는 .size씁니다
