...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("변형 : " + (int)cast1);       // 대문자 A = 65

        char cast2 = 'a';
        System.out.println("원형 : " + cast2);
        System.out.println("원형 : " + (int)cast2);       // 소문자 a = 97
        ...
        //다운캐스팅 파트
        int cast4 = 99;     // 애는 # 1방법으로,
        int cast5 = 100;    // 애는 # 2방법으로
        // 지시 사항 : 다운캐스팅하는 방법을 업캐스팅 방법 # 1, 2를 참조하여 char 형으로 바꾼후
