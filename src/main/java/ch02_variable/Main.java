...
/*
    ...
    즉, 주석이란 컴퓨터가 익어서 처리하는 부분이 아니라 사람이 읽어서 정보를 얻을 수 있는
    데에 의의가 있습니다.
...
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제 이름은 김서준입니다.");
//        System.out.println(안녕하세요, 제 이름은 김서준입니다.); -> 오류 발생
        ...
        // 데이터를 변수에 대입하고, 변수를 통햇허 명령을 내리는 것이 권장됨.
        ...
        boolean checkFalg2;     // 변수의 선언
        checkFalg2 = true;      // 변수의 초기화
        checkFalg2 = false;     // 변수의 재대입
...
//        int pi2 = 3.14;
        ...
        //위에 선언한 변수들에 여러분들에게 적합한 데이터로 '초기화'하여
