    ...
    1. Bank 클래스
        ...
        3) 메서드
            ...
            deposit(int amount, int inputPin) -> 입금 관련 메서드 / call2() 유형
                ...
                withdraw(int amount, int inputPin) -> 출금 관련 메서드 / ca112()
                    - 올바른 비밀번호인지 확인할 것 -> 틀리면 "비밀번호가 틀렸습니다." 하고 메서드 종료
                    - 유효한 금액인지 검증(amount가 0초과여야함) -> 실패하면 "불가능한 입력 금액입니다." 하고 메서드 종료
                ...
                deposit() / withdraw()를 실행시켜 입금 성공 및 실패 사례를 확인하고 통과되는지 검증해보시오.
...
//    public void setBalance(int balance)
    ...
    public void deposit(int amount, int inputPin) {
        ...
        //}
            ...
            if (amount > 0)  {
            balance += amount;
            System.out.println("입금 성공! 현재 잔액 : " + this.balance + "입니다."); // balance도 오류 안남
        } else {
                System.out.println("불가능한 입력 금액입니다. ");
            }
        // 비밀번호와 입력번호가 동일하다면 진행
    ...
    public void withdraw(int amount, int inputPin) {
        ...
        System.out.println("출금 성공! 현재 잔액 :" + this.balance + "입니다. ");
    ...
    public void ShowAccountInfo() {
        System.out.println(accountHolder + "님의 계좌번호는" + accountNum + "이며, 현재 잔액은" + this.balance + "입니다.");
