...
/*
    ...
    일반 for문과의 차이점 :
        ...
        세는 것이 번거롭기 때문에 배열명.length와 같은 방식으로 int값을 추출해서 한계값이 대입했습니다.

        그런데 잘 생각해보면 for (int i = 0; ...)으로 작성할 때 int i 는 for문의 내부에서 선언됩니다
        (일종의 지역변수)
...
public class Array06EnhancedFor {
    ...
    public static void main(String[] args) {
        ...
        String[] names = {"강미경", "김광호", "김규철", "김대웅", "김명규", "김민성", "김민호",
        "김서준", "김선영", "김재원", "김종보", "김호섭", "노소정", "염진우", "예영근",
        "이수원", "이진혁", "정선유", "제다정"};


        // for문으로 강미경 / 김광호 ... 출력
        // printElem(배열) 형태로 메서드 작성 -> int,String 다 사용
        // method 오버라이딩 적용
        // 메서드 호출을 위한 객체 생성
